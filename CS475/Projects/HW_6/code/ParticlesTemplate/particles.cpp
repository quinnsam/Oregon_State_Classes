...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Sam Quinn" };
const char *GLUITITLE   = { "Command Center Window" };
...
//const int NUM_PARTICLES = 64*1024;
//const int NUM_PARTICLES = 128*1024;
//const int NUM_PARTICLES = 256*1024;
//const int NUM_PARTICLES = 512*1024;
const int NUM_PARTICLES = 1024*1024;

const int LOCAL_SIZE    = 32;
const char *CL_FILE_NAME   = { "quinnsa_particles.cl" };
const char *CL_BINARY_NAME = { "quinnsa_particles.nv" };
...
InitLists( )
{
	...
	glNewList( SphereList, GL_COMPILE );
		...
		glPushMatrix( );
			...
			glutWireSphere( 200., 150., 150. );
		glPopMatrix( );
		
		// Sphere 3
		glColor3f(0., 0.,.9f);
		glPushMatrix();
			glTranslatef(0., -850., 1050.);
			glutWireSphere(400., 150., 150.);
		glPopMatrix();
	glEndList( );
