...
It has been proven that you should not use too small of an $e$ as they have been broken, for example $e=3$ and $e=7$. This attack is considered a small exponet attack. An adiquite size of key for $e$ would be $e=2^{16}+7$.  
